    ...
    <section className="py-8 sm:py-16 lg:py-24">
      ...
      >
        ...
        <div className="space-y-4 sm:w-1/2 lg:w-1/3">
          ...
          <h2 className="text-2xl font-semibold sm:text-3xl lg:text-4xl">Hear From Our Community</h2>

          <p className="text-muted-foreground text-xl">
            Real stories from real people who have made a difference through our platform.
          </p>
